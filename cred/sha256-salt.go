...
func (cm *Sha256SaltCredManager) GetHashedPassword(password string, userSalt string) string {
	res := getSha256HexDigest(password)
	return res
}

func (cm *Sha256SaltCredManager) IsPasswordCorrect(plainPwd string, hashedPwd string, userSalt string) bool {
