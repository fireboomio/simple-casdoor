...
func (cm *Pbkdf2SaltCredManager) GetHashedPassword(password string, userSalt string) string {
...
func (cm *Pbkdf2SaltCredManager) IsPasswordCorrect(plainPwd string, hashedPwd string, userSalt string) bool {
